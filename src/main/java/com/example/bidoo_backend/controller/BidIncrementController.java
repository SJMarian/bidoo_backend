...
public class BidIncrementController {
    ...
    @GetMapping("/api/v1/auctions/{id}/bid-state")
    ...
    @GetMapping("/api/v1/auctions/{id}/bids")
     ...
     */
    @GetMapping("/api/v1/auctions/{id}/validate-bid")
    ...
    @PostMapping("/api/v1/auctions/{id}/bids")
    ...
    @PutMapping("/api/v1/admin/auctions/{id}/increment-rule")
